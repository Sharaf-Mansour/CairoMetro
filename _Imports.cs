...
public static class Loaders
{
    public static Span<Station> Map => new Station[]
    {
        ...
        new(20, "Nasser", Line.Line1, "top:48.6%; left:31.9%;",true),
       ...
       // new(19, "Sadat", Line.Line1, "top:50.47%; left:49.04%;",true),
        ...
        new(20, "Mohamed Naguib", Line.Line2, "top:46.97%; left:37.13%;"),
        ...
        new(39, "Adly Mansour", Line.Line3, "top:01.35%; left:05.57%;"),
        new(38, "Hikestep", Line.Line3, "top:03.81%; left:05.57%;"),
        new(37, "Omar ibn Al-khattab", Line.Line3, "top:05.88%; left:05.57%;"),
        new(36, "Kebaa", Line.Line3, "top:08.28%; left:05.57%;"),
        new(35, "Hisham Barakat", Line.Line3, "top:10.79%; left:05.57%;"),
        new(34, "El-Nozha", Line.Line3, "top:13.25%; left:05.57%;"),
        new(33, "El-Shams Club", Line.Line3, "top:15.32%; left:05.57%;"),
        new(32, "Alf Masken", Line.Line3, "top:17.83%; left:05.57%;"),
        new(31, "Heliopolis Square", Line.Line3, "top:20.25%; left:05.57%;"),
        new(30, "Haroun", Line.Line3, "top:22.76%; left:05.57%;"),
        new(29, "Al-Ahram", Line.Line3, "top:25.21%; left:05.57%;"),
        new(28, "Koleyet El Banat", Line.Line3, "top:27.72%; left:05.57%;"),
        new(27, "Cairo Stadium", Line.Line3, "top:30.14%; left:05.57%;"),
        new(26, "Fair Zone", Line.Line3, "top:32.65%; left:05.57%;"),
        new(25, "Abbassia", Line.Line3, "top:35.09%; left:05.57%;"),
        new(24, "Abdou Pasha", Line.Line3, "top:37.60%; left:05.57%;"),
        new(23, "El Geish", Line.Line3, "top:40.02%; left:05.57%;"),
        new(22, "Bab El Shaaria", Line.Line3, "top:42.53%; left:05.57%;"),

        new(19, "Bab El Shaaria", Line.Line3, "top:50.33%; left:05.57%;"),
        new(18, "Bab El Shaaria", Line.Line3, "top:52.35%; left:05.57%;"),
        new(17, "Bab El Shaaria", Line.Line3, "top:54.72%; left:05.57%;"),
